...
public class GoldenCupItemUse : MonoBehaviour
{
    [SerializeField] private float waitForItemBuff;
    ...
    [SerializeField] private int attractionAmmount;
    ...
    {
        yield return new WaitForSeconds(waitForItemBuff);
        mainManager.ItemAttractionBoost(attractionAmmount, buffTime);
